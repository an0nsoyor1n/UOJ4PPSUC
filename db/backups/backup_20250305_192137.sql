...
INSERT INTO `problem_list_problems` VALUES (3,1,1);
...
CREATE TABLE `problem_lists` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_creator` (`creator_username`),
...
INSERT INTO `problem_lists` VALUES (3,'123','123','123','an0n','2025-03-05 02:40:04','2025-03-05 02:53:11',1),(4,'新题单',NULL,NULL,'an0n','2025-03-05 02:50:05','2025-03-05 02:50:05',1);
...
INSERT INTO `problems` VALUES (1,'New Problem',1,'{}',0,'{\"view_content_type\":\"ALL\",\"view_details_type\":\"ALL\"}',0,0,1);
...
INSERT INTO `submissions` VALUES (1,1,NULL,'2025-03-05 18:48:43','an0n','{\"file_name\":\"\\/submission\\/7215\\/lMlYgz3DEiqKMxndk2FH\",\"config\":[[\"problem_id\",\"1\"]]}','/',0,'2025-03-05 18:48:44',_binary '{\"score\":0,\"error\":\"Judgement Failed\",\"details\":\"Unknown Error\",\"status\":\"Judged\"}','Judged','Judgement Failed',NULL,0,0,1,'');
...
INSERT INTO `user_info` VALUES ('S','an0n','1257354171@qq.com','0d83098c4e4f5fca3f55c3057e6f6029','ECPQykOSXR',1500,0,'U',0,'2025-03-04 10:06:27','172.18.0.1','','gvvwxRMF3v2s2MBkQPdchYf4C7QwE4Ebih8PHuBanMkSdX5JfCizByQhxlf0','','202321710004','23Q104','23级数据一区');
...
-- Dump completed on 2025-03-05 19:21:38
